## CSS variables in SVG + CSS components {#svg-css-vars}

This change applies to all SVG + CSS component packages:

- [@iconify-vue/\* packages](/docs/usage/svg-css/vue/index.md) for Vue.
- [@iconify-svelte/\* packages](/docs/usage/svg-css/svelte/index.md) for Svelte.
- [@iconify-react/\* packages](/docs/usage/svg-css/react/index.md) for React.
- [@iconify-solid/\* packages](/docs/usage/svg-css/solid/index.md) for SolidJS.
