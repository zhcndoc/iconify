...
<template>
	<div>
		<button
			:class="copied ? copiedClassName : baseClassName"
		...
		>
			...
			>
				<path
					d="M5 3h14v18H5z"
					fill="var(--vp-c-bg)"
					class="animate-fill animate-delay-12"
				/>
				<g
					fill="none"
					stroke="currentColor"
				...
				>
					<g stroke-width="2">
						<g class="not-copied">
							...
							<path
								class="animate-line-44 animate-delay-2"
								d="M19 17V21H5V3H12"
							/>
							<path
								:class="copied ? '' : 'animate-line-10 animate-delay-10'"
								d="M21 14H12.5"
							/>
							<path
								:class="copied ? '' : 'animate-line-6 animate-delay-12'"
						...
						<g class="copied">
							...
							<path
								d="M22 7L13 16L10 13"
								:class="copied ? 'animate-line-20' : ''"
								stroke="var(--c-green)"
							/>
						</g>
					</g>
					<path
						class="animate-line-12 animate-delay-7"
